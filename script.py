...
# Content for the updated README.md file
readme_v2_content = """# SME Loan and KYC Onboarding System
...
print(f"README.md successfully written to: {os.path.abspath(output_path)}")